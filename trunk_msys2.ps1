...
#—————————————————————————————————————————————————————————————————————————————— Add gdbm & openssl
Write-Host "$($dash * 63) Installing gdbm-1.10" -ForegroundColor Yellow
...
Write-Host "$($dash * 63) Installing openssl-1.1.0" -ForegroundColor Yellow
